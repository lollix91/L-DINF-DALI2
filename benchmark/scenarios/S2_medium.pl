...
%% =============================================================================
%% Clinics: 3, Doctors/clinic: 3, Patients: 6
%% Disruptions: 3, Equivalent actions: 4
%% Total agents: 20
%% Seed: 43
%% =============================================================================
...
believes(trust(doc_a_2, medium)).
believes(trust(doc_a_3, high)).
believes(trust(doc_b_1, very_high)).
believes(trust(doc_b_2, low)).
believes(trust(doc_b_3, very_high)).
believes(trust(doc_c_1, very_high)).
believes(trust(doc_c_2, medium)).
...
believes(success_prob(visit(doc_b_1), 0.77)).
believes(success_prob(visit(doc_b_2), 0.59)).
believes(success_prob(visit(doc_b_3), 0.92)).
believes(success_prob(visit(doc_c_1), 0.8)).
believes(success_prob(visit(doc_c_2), 0.95)).
believes(success_prob(visit(doc_c_3), 0.84)).
...
believes(action_data(visit_type_1, 0.93, 6, 6)).
believes(action_data(visit_type_2, 0.86, 3, 2)).
believes(action_data(visit_type_3, 0.68, 7, 7)).
believes(action_data(visit_type_4, 0.57, 8, 2)).
...
believes(success_prob(visit(doc_c_1), 0.56)).
believes(success_prob(visit(doc_c_2), 0.88)).
...
believes(action_data(visit_type_1, 0.86, 8, 4)).
believes(action_data(visit_type_2, 0.84, 8, 5)).
believes(action_data(visit_type_3, 0.81, 8, 6)).
believes(action_data(visit_type_4, 0.72, 2, 3)).
believes(policy_weights(100, 10, 20)).
believes(pref_max(10)).
...
believes(success_prob(visit(doc_a_1), 0.88)).
...
believes(success_prob(visit(doc_b_3), 0.77)).
believes(success_prob(visit(doc_c_1), 0.59)).
believes(success_prob(visit(doc_c_2), 0.56)).
...
believes(action_data(visit_type_1, 0.6, 5, 2)).
believes(action_data(visit_type_2, 0.79, 8, 4)).
believes(action_data(visit_type_3, 0.71, 3, 1)).
believes(action_data(visit_type_4, 0.63, 3, 6)).
believes(policy_weights(100, 10, 20)).
believes(pref_max(10)).
...
believes(success_prob(visit(doc_a_3), 0.85)).
believes(success_prob(visit(doc_b_1), 0.67)).
believes(success_prob(visit(doc_b_2), 0.83)).
believes(success_prob(visit(doc_b_3), 0.58)).
...
believes(action_data(visit_type_1, 0.87, 9, 7)).
believes(action_data(visit_type_2, 0.86, 10, 2)).
believes(action_data(visit_type_3, 0.64, 4, 1)).
believes(action_data(visit_type_4, 0.83, 3, 4)).
believes(policy_weights(100, 10, 20)).
believes(pref_max(10)).
...
believes(action_data(visit_type_1, 0.65, 6, 1)).
believes(action_data(visit_type_2, 0.96, 6, 3)).
believes(action_data(visit_type_3, 0.89, 5, 3)).
believes(action_data(visit_type_4, 0.63, 10, 4)).
believes(policy_weights(100, 10, 20)).
believes(pref_max(10)).
...
believes(success_prob(visit(doc_a_1), 0.61)).
...
believes(success_prob(visit(doc_b_3), 0.62)).
believes(success_prob(visit(doc_c_1), 0.85)).
believes(success_prob(visit(doc_c_2), 0.72)).
...
believes(action_data(visit_type_1, 0.84, 5, 8)).
believes(action_data(visit_type_2, 0.85, 10, 7)).
believes(action_data(visit_type_3, 0.76, 4, 6)).
believes(action_data(visit_type_4, 0.55, 6, 6)).
believes(policy_weights(100, 10, 20)).
believes(pref_max(10)).
...
believes(doctor_pref(doc_a_1, 6)).
believes(doctor_available(doc_a_1)).
believes(doctor_trust(doc_a_2, medium)).
believes(doctor_pref(doc_a_2, 9)).
believes(doctor_available(doc_a_2)).
believes(doctor_trust(doc_a_3, high)).
believes(doctor_pref(doc_a_3, 3)).
...
believes(doctor_trust(doc_b_1, very_high)).
believes(doctor_pref(doc_b_1, 9)).
...
believes(doctor_trust(doc_b_3, very_high)).
believes(doctor_pref(doc_b_3, 7)).

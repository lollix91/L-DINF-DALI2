...
believes(doctor_trust(doc_a_2, low)).
believes(doctor_pref(doc_a_2, 4)).
believes(doctor_available(doc_a_2)).
believes(doctor_trust(doc_a_3, very_high)).
believes(doctor_pref(doc_a_3, 5)).
...
believes(doctor_trust(doc_b_3, medium)).
believes(doctor_pref(doc_b_3, 10)).
believes(doctor_available(doc_b_3)).
believes(doctor_trust(doc_b_4, high)).
believes(doctor_pref(doc_b_4, 8)).
...
believes(doctor_pref(doc_c_2, 3)).
believes(doctor_available(doc_c_2)).
believes(doctor_trust(doc_c_3, high)).
believes(doctor_pref(doc_c_3, 6)).
believes(doctor_available(doc_c_3)).
believes(doctor_trust(doc_c_4, medium)).
believes(doctor_pref(doc_c_4, 3)).
